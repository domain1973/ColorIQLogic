package com.ads.logic.color.android;
...
public class AndroidLauncher extends AndroidApplication implements InitCallbackListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View gameView = initializeForView(new Logic(pEvent), config);
        // 创建布局
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            new AlertDialog.Builder(AndroidLauncher.this).setTitle("迪士尼迷宫").setMessage("购买完成！请重新启动游戏,去广告才有效.")
                                    ...
                                    }).setIcon(com.ads.logic.color.android.R.drawable.xiaozi).create().show();
                        }
                    });
                    //添加到已处理订单列表
